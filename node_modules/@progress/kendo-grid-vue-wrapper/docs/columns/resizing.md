---
title: Resizing
page_title: Vue Grid Columns - Column Resizing - Kendo UI
...
You can enable the resizing feature of the Kendo UI Grid for Vue columns by using its `resizable` property.
